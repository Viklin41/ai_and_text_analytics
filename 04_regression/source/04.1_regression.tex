...
\lhead{Introduction to AI - 04.1\_regression - Conor}
\rhead{\thepage}
\cfoot{}
...
\begin{center}
  \includegraphics[]{04.1_points.png}
  \end{center}
...
\begin{center}
  \includegraphics[]{04.1_points_line.png}
  \end{center}
...
\begin{center}
  \includegraphics[]{04.1_contour.png}
  \end{center}
...
The contours are
\begin{center}
  \includegraphics[]{04.1_simple_contour.png}
  \end{center}
...
\begin{center}
  \includegraphics[]{04.1_gradient.png}
  \end{center}
...
\begin{center}
  \includegraphics[]{04.3_gradient_big_eta.png}
  \end{center}
